    ...
    return (
        <form className={cn('flex flex-col gap-6', className)} {...props} onSubmit={submit}>
            ...
            <div className="flex flex-col items-center gap-2 text-center">
                <a href="/" className="bg-blue-500 p-2 rounded-md">
            ...
            <div className="mt-4 grid gap-6">
                <div className="grid gap-2">
                    ...
                    <Input
                        ...
                        className="h-11 rounded-none py-4"
                    />
                ...
                <Button type="submit" className="h-11 w-full cursor-pointer rounded-none bg-blue-500 hover:bg-blue-600" disabled={processing}>
