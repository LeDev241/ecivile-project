...
const Combobox: React.FC<ComboboxProps> = ({ options, value, onChange, placeholder, maxVisible = 5 }) => {
    ...
    return (
        <div className="relative" ref={containerRef}>
            <Input
                ...
                className="mt-1 block w-full focus:ring focus:ring-blue-500 focus:outline-none"
            />
