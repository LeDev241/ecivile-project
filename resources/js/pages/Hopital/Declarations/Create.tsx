...
export default function Index() {
  ...
  return (
    <HopitalLayout>
      ...
      <div className="p-4">
        <h1 className="mb-4 text-lg font-semibold text-gray-800 dark:text-gray-100">Créer une Déclaration de Naissance</h1>
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <label className="flex items-center gap-2">
                      <input
                        ...
                        name="date_option"
                        value="today"
                        checked={data.date_option === 'today'}
                        onChange={() => {
                          setData('date_option', 'today');
                          // on met la date du jour automatiquement
                          const today = new Date().toISOString().split('T')[0];
                          setData('date_naissance', today);
                        }}
                      />
                  ...
                  {/* Input date (visible seulement si choix manuel) */}
                  {data.date_option === 'manual' && (
                    <Input
                      id="date_naissance"
                      type="date"
              ...
              <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
                <div className="col-span-1 md:col-span-2 lg:col-span-3">
                  ...
                  <RadioGroup defaultValue={data.sexe} onValueChange={(value) => setData('sexe', value)} className="mt-2 flex space-x-4">
