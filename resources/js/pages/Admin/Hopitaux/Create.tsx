...
export default function Create({ mairies }) {
    ...
    const submit = (e) => {
        e.preventDefault();
        post(route('admin.hopitaux.store'));
    };
    ...
    return (
        <AdminLayout>
            ...
            <div className="container mx-auto space-y-4 px-4">
                <h3 className="mb-4 text-lg font-semibold text-gray-800 dark:text-white">Créer un hopital</h3>
                    ...
                    <div className="grid gap-4 sm:grid-cols-2">
                        ...
                        <div className="space-y-2">
                            ...
                            <Select onValueChange={(value) => setData('mairie_id', value)} value={data.mairie_id}>
                                ...
                                <SelectContent className="rounded-none">
                                    {mairies.map((mairie) => (
                                        <SelectItem key={mairie.id} value={String(mairie.id)}>
                                            {mairie.nom}
                                        </SelectItem>
                                    ))}
                                </SelectContent>
