        ...
        <AdminLayout>
            ...
            <div className="flex flex-1 flex-col gap-4 overflow-x-auto rounded-xl p-4">
                <div className="h-auto overflow-hidden rounded-xl border border-sidebar-border/70 p-4 md:min-h-min dark:border-sidebar-border">
                    <h3 className="mb-4 text-lg font-semibold text-primary">Gestionnaires des hopitaux</h3>
                    <Button asChild>
                ...
                <div className="space-y-2">
                    <div className="flex flex-wrap items-center justify-between">
                        <h3 className="text-lg font-semibold text-primary">Liste des hopitaux</h3>
